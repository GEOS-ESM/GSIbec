...
!$$$
  ...
  use gridmod, only: lat2,lon2,nsig,istart,rlats,nlat,idvc5,bk5,nthreads,regional
  use gridmod, only: jtstart,jtstop
#ifdef USE_ALL_ORIGINAL
  use gridmod, only: jstart,region_lat,eta2_ll,wrf_nmm_regional,nems_nmmb_regional,nlon,&
     region_dx,region_dy
#endif
